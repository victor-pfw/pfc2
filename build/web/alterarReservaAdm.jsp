...
<html>
    ...
    <body>
         ...
         <%
            List<Reserva> exibirPorId = (List<Reserva>) request.getAttribute("listaPorId");
        ...
        <div class="container">  
            ...
            <form id="contact" action="ControleReserva" method="post">
                <h3><b>Altere os dados da sua reserva</b></h3>
                ...
                <fieldset>
                    ...
                    <input type="number" placeholder="Quantidade de pessoas" name="quantidade_pessoas" min="1" max="30"   value="<%=usuario.getQuantidade_pessoa()%>">
                </fieldset>
                 <fieldset>
                ...
                --%>
                <fieldset>
                    <button type="submit"  value="Alterar" name="acao" >Alterar dados</button>

                </fieldset>

              <a href="ControleReserva?acao=Listar">Voltar</a>   
