                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            ...
                            <table class="table">
                                ...
                                <%
                                    List<Usuario> exibir = (List<Usuario>) request.getAttribute("listaUsuarios");

                                    for (Usuario r : exibir) {
                                %>

                                <tr>
                                    <td><%=r.getId_usuario()%></td>
                                    <td><%=r.getEmail()%></td>
                                    <td><%=r.getLogin()%></td>
                                    <td><a href="ControleUsuario?acao=ExcluirUsuario&id_usuario=<%=r.getId_usuario()%>">Remover</a></td>    
