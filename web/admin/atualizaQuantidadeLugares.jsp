                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            ...
                            <Center><font color="blue"><%=msg%></font></center> 
                                <%}%>
                            <form id="contact" action="../ControleLugares" method="post">

                           
                                <label>Quantidade de lugares por dia  :</label>
                                <input type="text"  name="quantidade_lugares"  required >
                                <input type="date" name="data_da_quantidade" required>
                                
                                <button type="submit" value="atualizarLugares" name="acao" class="btn"  >Atualizar quantidade</button>
