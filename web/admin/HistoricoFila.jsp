...
<%@page import="Modelo.ListaDeEspera"%>
                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            ...
                            <table class="table">
                                ...
                                <th>Código da reserva em fila</th>
                                <th>Email</th>
                                </thead>

                                <%
                                    List<ListaDeEspera> exibir = (List<ListaDeEspera>) request.getAttribute("FilaGeral");

                                    for (ListaDeEspera r : exibir) {
                                %>

                                <tr>
                                    <td><%=r.getId_lista_reserva()%></td>
                                    <td><%=r.getEmail()%></td>
